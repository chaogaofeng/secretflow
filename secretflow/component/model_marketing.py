...
def ss_compare_eval_fn(
    ...
    params_pyu_obj = wait(rule_pyu(prepare_params)(rule_endpoint, param_columns, 'qualified_suppliers'))
    ...
    ret_df = wait(data_pyu(processed_marketing)(df_pyu_obj, ret_pyu_obj))
